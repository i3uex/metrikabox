...
AVAILABLE_AUDIO_AUGMENTATIONS = {class_loader_name: class_loader for class_loader_name, class_loader in getmembers(importlib.import_module('audio_classifier.augmentations.audio'), isclass)}
AVAILABLE_SPECTROGRAM_AUGMENTATIONS = {class_loader_name: class_loader for class_loader_name, class_loader in getmembers(importlib.import_module('audio_classifier.augmentations.spectrogram'), isclass)}